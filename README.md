...
- `ADMIN_USERNAME`, `ADMIN_PASSWORD`: direct administrator login credentials (password minimum 12 characters). `ADMIN_EMAIL` or `ADMIN_EMAILS` is optional and used only by legacy email-based administrator flows.
