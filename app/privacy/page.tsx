...
export default function PrivacyPage() {
  return <main className="appShell"><AppNav light/><article className="legalPage">
    ...
    <section><h2>First-party usage analytics</h2><p>CarrerFit records visited page paths, page-view counts, device category, and active time to operate and improve the service. Signed-in activity can be associated with the account for administrator support and product analytics. A new browser session may generate an operational notification to the site administrator. We do not record keystrokes, form contents, full query strings, or use a third-party advertising tracker.</p></section>
